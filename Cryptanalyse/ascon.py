...
def generate_hash():
    plaintext = bytes(sys.argv[1], 'utf-8')
    # 256-bit output
    variant = "Ascon-Hash"
    hashlength = 32
    hash_code = ascon_hash(plaintext, variant, hashlength)
    print(hash_code.hex(), end='')
...
print(ascon_decrypt(b"\x00\x45\x6c\x6c\x61\x6e\x61\x20\x64\x27\x41\x6c\x2d\x46\x61\x72", b"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00", b"\x80\x40\x0c\x06\x00\x00\x00\x00", b"").decode("unicode_escape"))