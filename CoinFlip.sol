...
contract CoinFlip {
    ...
    function withdrawAll() public {
        require(playerBalance[msg.sender] > 0, "Vous n'avez aucun token a retirer");
    ...
    function flipCoin(bool _guess, uint256 randomHelper) public {
        ...
        require(playerBalance[msg.sender] * 2 <= contractBalance,"Votre pari ne doit pas depasser une certaine limite");
    ...
    function withdrawOwner() public {
        require(msg.sender == owner, "Seul le proprietaire peut retirer les fonds");
        contractBalance = 0;
